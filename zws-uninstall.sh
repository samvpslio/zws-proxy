...
if [ $SOK_OS == "ERROR" ]; then
    ...
    echo "Contact https://zwscloud.com/order/contact.php to add support for your OS."
    exit 1;
fi
...
echo 
echo 
echo "ZWS CLOUD Proxy uninstalled."
echo "Thank you for using zwscloud.com AD proxy installer"
echo "If you want to reinstall ZWS CLOUD Proxy Server, check https://zwscloud.com/proxy"
echo 
